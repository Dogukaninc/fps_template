...
namespace _Main.Scripts.WeaponSystem.Weapons
{
    ...
    public class WeaponRifleController : BaseWeapon
    {       
        ...
        public override void FireWeapon()
        {
            ...
            _shootingData.DefaultProjectileShooting(currentWeaponData.shootPoint.position, currentWeaponData.shootPoint.forward, currentWeaponData.range, currentWeaponData);
            Debug.Log("Rifle ateş etti");
        }
    }
}